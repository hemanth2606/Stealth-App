...
public class editProfileActivity extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists() && snapshot.getChildrenCount()>0){
                    if(snapshot.hasChild("weight")){
                        ...
                        binding.weightText.setText(weight + " Kg");
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists() && snapshot.getChildrenCount()>0){
                    if(snapshot.hasChild("Age")){
                        String dateOfBirth = snapshot.child("Age").getValue().toString();
    ...
    private void ageDialog(){
        ...
        NumberPicker ageNumberPicker = dialog.findViewById(R.id.ageNumberPicker);
        Button saveButton = dialog.findViewById(R.id.ageSaveButton);
        Button cancelButton = dialog.findViewById(R.id.ageCancelButton);
        ageNumberPicker.setMaxValue(120);
        ageNumberPicker.setMinValue(15);
        ageNumberPicker.setValue(21);
        saveButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int ageValue = ageNumberPicker.getValue();
                ...
                binding.birthDateText.setText(ageValue +"");
                dialog.dismiss();
            }
        });
        cancelButton.setOnClickListener(new View.OnClickListener() {
